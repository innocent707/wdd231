( () => {
    ...
    function a(e, t, o, n) {}
    function l(e) {
        return e.offsetTop + (e.offsetParent ? l(e.offsetParent) : 0)
    }
    function d() {}
    let c, p;
    const f = function(e) {
    ...
    class u {
        ...
        makeHighlightDiv(a, l) {
            const d = a.getBoundingClientRect()
              ...
              , u = parseFloat(p.getPropertyValue("transition-duration"))
              , g = parseFloat(p.getPropertyValue("animation-duration"));
            if (u && f(u),
            g && f(g),
            0 === d.width && 0 === d.height)
                return;
            const h = {
                right: p.getPropertyValue("border-right-width"),
                left: p.getPropertyValue("border-left-width"),
                top: p.getPropertyValue("border-top-width"),
                bottom: p.getPropertyValue("border-bottom-width")
            }
              , m = "border-box" === p.boxSizing;
            let y = parseFloat(p.width)
              , w = parseFloat(p.height)
              , b = w
              , v = y;
            m || (y += parseFloat(p.paddingLeft) + parseFloat(p.paddingRight),
            w += parseFloat(p.paddingTop) + parseFloat(p.paddingBottom),
            ...
            const x = {
              ...
              , P = function(e) {
                const t = {};
                return x.horizontal.indexOf(e) >= 0 ? (t.width = p.getPropertyValue("padding-" + e),
                t.height = w + "px",
                t.top = 0,
                m && (t.height = w - parseFloat(h.top) - parseFloat(h.bottom) + "px")) : (t.height = p.getPropertyValue("padding-" + e),
                t.width = y + "px",
                t.left = 0,
              ...
              , F = function(e) {
                const t = {}
                  , o = [];
                return o.right = parseFloat(p.getPropertyValue("margin-right")),
                o.top = parseFloat(p.getPropertyValue("margin-top")),
                o.bottom = parseFloat(p.getPropertyValue("margin-bottom")),
                o.left = parseFloat(p.getPropertyValue("margin-left")),
                x.horizontal.indexOf(e) >= 0 ? (t.width = p.getPropertyValue("margin-" + e),
                t.height = b + o.top + o.bottom + "px",
                t.top = "-" + (o.top + parseFloat(h.top)) + "px") : (t.height = p.getPropertyValue("margin-" + e),
                t.width = v + "px",
                t.left = "-" + h.left),
              ...
              , E = [P("top"), P("right"), P("bottom"), P("left")]
              , k = function(e, t) {
                let o;
            ...
            k([F("top"), F("right"), F("bottom"), F("left")], r),
            k(E, n),
            c.className = e,
            function(e) {
            ...
            const H = {
                ...
                "box-sizing": p.getPropertyValue("box-sizing"),
                "border-right": p.getPropertyValue("border-right"),
                "border-left": p.getPropertyValue("border-left"),
                "border-top": p.getPropertyValue("border-top"),
                "border-bottom": p.getPropertyValue("border-bottom"),
                transform: p.getPropertyValue("transform"),
                "transform-origin": p.getPropertyValue("transform-origin"),
                "border-color": i
            }
              , V = Object.assign({}, H)
              , L = t
    ...
    let h;
    const m = !!document.body && document.body.hasAttribute("data-server-no-reload");
    m && console.info("[Five Server] Reload disabled due to 'data-server-no-reload' attribute on BODY element"),
    "WebSocket"in window && !m && window.addEventListener("load", () => {
        ...
        r && "true" === r.toString() && (h = document.body ? document.body.cloneNode(!0) : void 0);
        let i = null;
        const s = new u(!0);
        s.redraw(),
                ...
                "reload" === t.data)
                    ...
                    ( () => {
                        ...
                        console.log = function(...t) {
                            "[Five Server] connected." === t[0] ? p("connected", "success") : f("log", ...t),
                            e.apply(console, t)
                        }
                        ;
        ...
        const S = () => {
          ...
          , E = () => g(void 0, void 0, void 0, function*() {
            F++;
